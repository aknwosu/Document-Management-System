...
describe('Roles', () => {
  ...
  describe('Create Roles', () => {
    it('should create a role', (done) => {
      request.post('/api/roles').send(testFile.newRole)
  ...
  describe('Get roles', () => {
    ...
    it('should not return all roles to a non admin', (done) => {
      request.post('/api/users').send(testFile.regularUser2)
      .then((newRoleUser) => {
